...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getResponseStatus, getRequestHost, getRequestProtocol, setHeader, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withTrailingSlash, decodePath, withLeadingSlash, joinRelativeURL, withoutProtocol, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/destr/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/devalue/index.js';
import { toValue, isVNode, isRef } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/source-map/source-map.js';
import devalue from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, basename } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/.nuxt/nuxt-icon-server-bundle.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/.data/kv"}));
...
const _cJAh_t6TkSrioqOLikS62_QUjzBPQvvgmmt85jkpvhU = (function(nitro) {
...
const _6ij7zjipOO0BL2ynRLDZdTodxg0DYOFVSTU2kUFnB4 = defineNitroPlugin(async (nitroApp) => {
...
const _i9o34SZO1hSaeqKRdlBtOFrBQqq_ed9rXEDD9_ljzj8 = defineNitroPlugin(async (nitroApp) => {
...
const rootDir = "C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6";
...
const _HPxhjmV_hK4d1BpKl4jdMF2gjJEy1kiABhf3RHBb_ys = (nitroApp) => {
...
const _6IqiTYQ9cmlmjpK9h_SC5OGFXq0Vhv7oa6jzfCnfDAc = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _cJAh_t6TkSrioqOLikS62_QUjzBPQvvgmmt85jkpvhU,
_6ij7zjipOO0BL2ynRLDZdTodxg0DYOFVSTU2kUFnB4,
_i9o34SZO1hSaeqKRdlBtOFrBQqq_ed9rXEDD9_ljzj8,
_HPxhjmV_hK4d1BpKl4jdMF2gjJEy1kiABhf3RHBb_ys,
_6IqiTYQ9cmlmjpK9h_SC5OGFXq0Vhv7oa6jzfCnfDAc
];
...
const _rXlcgu = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _1SHYki = defineCachedEventHandler(async (event) => {
...
const _rwrByg = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
  const runtimeConfig = useRuntimeConfig(e);
...
const _ctIUJs = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file://C:/4_curriculum/Vue.js/lab/VueJSLabs2025/lab6/node_modules/fast-xml-parser/src/fxp.js');
...
const _2isxuo = defineEventHandler(async (e) => {
...
const _RHo_qj = defineEventHandler(async (e) => {
...
const _gEk_ym = defineEventHandler(async (e) => {
...
const _XRvsJG = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _rFA2Df = defineEventHandler(async (e) => {
...
const _F9rbjc = defineEventHandler(async (e) => {
...
const _5GzbqJ = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const _lazy_XCcj6M = () => Promise.resolve().then(function () { return posts_get$1; });
const _lazy_0jOA8d = () => Promise.resolve().then(function () { return _slug__get$1; });
const _lazy_AI5y4J = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _rXlcgu, lazy: false, middleware: true, method: undefined },
  { route: '/api/posts', handler: _lazy_XCcj6M, lazy: true, middleware: false, method: "get" },
  { route: '/api/posts/:slug', handler: _lazy_0jOA8d, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_AI5y4J, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _1SHYki, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _rwrByg, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _ctIUJs, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _2isxuo, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _RHo_qj, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _gEk_ym, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _XRvsJG, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _rFA2Df, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _F9rbjc, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _5GzbqJ, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_AI5y4J, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_AI5y4J, lazy: true, middleware: false, method: undefined }
];
