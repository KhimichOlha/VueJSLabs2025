import { computed, toValue, reactive, unref, mergeProps, withCtx, renderSlot, useSlots, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, Fragment, renderList, toRef, inject, isRef, ref, useSSRContext } from 'vue';
import { E as hash, D as defu } from '../_/nitro.mjs';
import { isPlainObject } from '@vue/shared';
import { f as fetchDefaults, c as useAppConfig, b as useRequestFetch } from './server.mjs';
import { u as useAsyncData } from './index-B_dZfzIn.mjs';
...
import { b as _sfc_main$3, a as _sfc_main$5, _ as _sfc_main$2, g as get } from './Button-BiQAXVSL.mjs';
            ...
            return [
              ...
              __props.orientation === "horizontal" && (__props.actions?.length || !!slots.actions) || __props.close ? (openBlock(), createBlock("div", {
                ...
                renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                  __props.close ? (openBlock(), createBlock(_sfc_main$2, mergeProps({
                    key: 0,
                    icon: __props.closeIcon || unref(appConfig).ui.icons.close,
                    color: "neutral",
                    variant: "link",
...
export { _sfc_main$1 as _, _sfc_main as a, useFetch as u };
//# sourceMappingURL=Alert-CJswVd-3.mjs.map
