...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: posts, status, error } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/posts", "$pD-mX6tkcV")), __temp = await __temp, __restore(), __temp);
    useSeoMeta({
...
//# sourceMappingURL=index-BA4Z4plV.mjs.map
